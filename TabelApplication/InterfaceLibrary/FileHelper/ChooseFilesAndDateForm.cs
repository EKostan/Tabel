...
{
    public partial class ChooseFilesAndDateForm : XtraForm
    {
        public string Path
        {
            get
        ...
        private void ChooseFilesAndDateForm_DragDrop(object sender, DragEventArgs e)
        {
        ...
        private void ChooseFilesAndDateForm_DragEnter(object sender, DragEventArgs e)
        {
